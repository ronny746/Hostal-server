...
exports.generateBillPDF = async (req, res) => {
    try {
        ...
        const columnWidths = [40, 200, 100, 100, 100]; // S.No, Item Name, Quantity, Unit Price, Total
        
        // Draw table header with border
        doc.rect(40, tableHeaderY, tableWidth, 20).fill('#f0f0f0').stroke();
        ...
        // Draw line between items and totals
        ...
        doc.fontSize(12).font('Poppins').text('Grand Total', 400, currentY, { align: 'center' });
