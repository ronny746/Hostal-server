...
const HostelSchema = new mongoose.Schema(
    {
        ...
        state: { type: String },
        country: { type: String, required: f },
        zipcode: { type: String },
        description: { type: String }, // Brief description of the hostel
        images: { type: [String] }, // Array of image URLs
        price: { 
            basePrice: { type: Number, required: true }, // Base price per night
        ...
        nearbyAttractions: [
            {
                name: { type: String },
                distance: { type: Number }, // Distance in kilometers or miles
                description: { type: String },
            },
        ],
